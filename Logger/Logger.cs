...
namespace Logger
{
	...
	public static class Logger
	{
		...
		public static void InformationCalledMethod(string nameClass, string nameMethod) => 
			WriteLog($"Call in {nameClass} method {nameMethod}");
		...
		/// <param name="nameClass">Имя класса</param>
		/// <param name="nameMethod">Имя вызванного метода</param>
		public static void InformationSuccesMethod(string nameClass, string nameMethod) =>
			WriteLog($"Succes method {nameMethod} in {nameClass}");
		...
		/// <param name="nameClass">Имя класса</param>
		/// <param name="nameMethod">Имя вызванного метода</param>
		public static void Error(Exception exception, string nameClass, string nameMethod) =>
			WriteLog($"Error > {exception.Message} :> {nameClass} ----> {nameMethod}");
	}
